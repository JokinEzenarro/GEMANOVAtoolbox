function model = gemanovaInit(X,F,Fix,scl,init)
%GEMANOVA - GEneralized Multiplicative ANOVA
%modified to use another GEMANOVA model as initial estimates.
...
%
% A fifth optional input, init, can offer initialisation loadings by 
% inputting a PARAFAC/GEMANOVA model. 
% 
% OUPUTS
...
%rb February, 2001
% Modified by Jokin Ezenarro, 2025
...
function [m,fit]=parafacones(X,F,Fix,maxit,model,show)
